...
def attend():
    os.startfile(os.getcwd()+"/firebase/attendance_files/attendance"+str(datetime.date.today())+'.xls')

#stting title for the window
root.title("Automatic attendance approaches through face recognition")
